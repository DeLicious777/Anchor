...
- **Dashboard** (full window): the **History View** of all Time Blocks (name, project/client, start/end, duration, and the three metadata fields), Task Template management, and export actions (XLSX/JSON). Not meant for rapid interaction — opened deliberately, not part of the fast switch/interrupt/return loop.
...
- The History View shows every Time Block with correct start/end/duration.
